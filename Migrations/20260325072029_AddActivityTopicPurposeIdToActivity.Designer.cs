...
namespace crm_api.Migrations
{
    ...
    [Migration("20260325072029_AddActivityTopicPurposeIdToActivity")]
    partial class AddActivityTopicPurposeIdToActivity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("crm_api.Models.Activity", b =>
                {
                    ...
                    b.Property<long?>("ActivityMeetingTypeId")
                        .HasColumnType("bigint");

                    b.Property<long?>("ActivityShippingId")
                        .HasColumnType("bigint");

                    b.Property<long?>("ActivityTopicPurposeId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("crm_api.Models.ActivityMeetingType", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("CreatedDate")
                        .HasDatabaseName("IX_ActivityMeetingType_CreatedDate");

                    b.HasIndex("DeletedBy");

                    b.HasIndex("IsDeleted")
                        .HasDatabaseName("IX_ActivityMeetingType_IsDeleted");

                    b.HasIndex("Name")
                        .HasDatabaseName("IX_ActivityMeetingType_Name");

                    b.HasIndex("UpdatedBy");

                    b.ToTable("RII_ACTIVITY_MEETING_TYPE", (string)null);
                });
            ...
            modelBuilder.Entity("crm_api.Models.ActivityShipping", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("CreatedDate")
                        .HasDatabaseName("IX_ActivityShipping_CreatedDate");

                    b.HasIndex("DeletedBy");

                    b.HasIndex("IsDeleted")
                        .HasDatabaseName("IX_ActivityShipping_IsDeleted");

                    b.HasIndex("Name")
                        .HasDatabaseName("IX_ActivityShipping_Name");

                    b.HasIndex("UpdatedBy");

                    b.ToTable("RII_ACTIVITY_SHIPPING", (string)null);
                });

            modelBuilder.Entity("crm_api.Models.ActivityTopicPurpose", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("CreatedDate")
                        .HasDatabaseName("IX_ActivityTopicPurpose_CreatedDate");

                    b.HasIndex("DeletedBy");

                    b.HasIndex("IsDeleted")
                        .HasDatabaseName("IX_ActivityTopicPurpose_IsDeleted");

                    b.HasIndex("Name")
                        .HasDatabaseName("IX_ActivityTopicPurpose_Name");

                    b.HasIndex("UpdatedBy");

                    b.ToTable("RII_ACTIVITY_TOPIC_PURPOSE", (string)null);
                });
            ...
            modelBuilder.Entity("crm_api.Models.ReportBuilder.ReportAssignment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("RII_REPORT_ASSIGNMENTS", (string)null);
                });
            ...
            modelBuilder.Entity("crm_api.Models.Activity", b =>
                {
                    b.HasOne("crm_api.Models.ActivityMeetingType", "ActivityMeetingType")
                        .WithMany()
                        .HasForeignKey("ActivityMeetingTypeId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("crm_api.Models.ActivityShipping", "ActivityShipping")
                        .WithMany()
                        .HasForeignKey("ActivityShippingId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("crm_api.Models.ActivityTopicPurpose", "ActivityTopicPurpose")
                        .WithMany()
                        .HasForeignKey("ActivityTopicPurposeId")
                        .OnDelete(DeleteBehavior.NoAction);
                    ...
                    b.Navigation("ActivityMeetingType");

                    b.Navigation("ActivityShipping");

                    b.Navigation("ActivityTopicPurpose");
            ...
            modelBuilder.Entity("crm_api.Models.ReportBuilder.ReportAssignment", b =>
                {
                    ...
                    b.HasOne("crm_api.Models.ReportBuilder.ReportDefinition", "ReportDefinition")
