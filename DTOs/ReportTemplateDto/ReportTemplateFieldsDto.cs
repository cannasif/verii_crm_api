        ...
        public static ReportTemplateFieldsDto GetFields()
        {
            return new ReportTemplateFieldsDto
            {
                HeaderFields = new List<FieldDefinition>
                {
                    ...
                    new FieldDefinition { Label = "En Son Müşteri Görseli", Path = "CustomerLatestImageUrl", DataType = "string", ExampleValue = "/uploads/customer-images/42/cardsample.jpg" },
                    new FieldDefinition { Label = "Kartvizit Görseli (Uyumluluk)", Path = "PrimaryImageUrl", DataType = "string", ExampleValue = "/uploads/customer-images/42/cardsample.jpg" },
